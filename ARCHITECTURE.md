...
2. Holding the Enter/action key for one second starts or stops recording without emitting Enter. The key keeps its normal action icon plus a microphone badge and reflects recording or transcription state locally. The app does not stream partial audio or text.
